...
import { validateChoiceName, validateName } from '../../utils/validations.mjs'
import { TypeFromDiscordOptionType } from '../../command/options_parser.mjs'

export type ChoosableTypes = DiscordOptionTypes.STRING | DiscordOptionTypes.NUMBER | DiscordOptionTypes.INTEGER

export interface Choice<
    TValue extends TypeFromDiscordOptionType<DiscordOptionTypes> = TypeFromDiscordOptionType<DiscordOptionTypes>,
> {
    name: string
...
export class ChoiceBuilder<
    ...
    TValue extends TypeFromDiscordOptionType<TType> = TypeFromDiscordOptionType<TType>,
> implements Choice<TValue>
{
    declare public readonly name: string
    declare public readonly value: TValue
    declare public readonly name_localizations?: Partial<Readonly<Record<Locale, string>>>
...
export function choice<TType extends ChoosableTypes, TValue extends TypeFromDiscordOptionType<TType>>(
    name: string,
    value: TValue
): ChoiceBuilder<TType, TValue> {
