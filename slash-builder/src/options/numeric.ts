...
import { BaseChoosableOption, BaseChoosableOptionBuilder } from "./common-choosable";
...
implements NumericOption<TName, TRequired, TInputs> {
    ...
    constructor(name: TName, type: DiscordOptionTypes.INTEGER | DiscordOptionTypes.NUMBER) {
        super(name);
        this.type = type
    }
